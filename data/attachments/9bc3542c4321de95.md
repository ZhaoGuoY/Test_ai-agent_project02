...
- generic [active] [ref=e1]:
        ...
        - generic [ref=e512]:
          - generic [ref=e514]:
            - generic [ref=e516] [cursor=pointer]:
              - img [ref=e517]
              - iframe [ref=e579]:
                - generic [active] [ref=f277e1]:
                  - generic "YouTube 動画プレーヤー" [ref=f277e3]
                  - generic [ref=f277e5]:
                    - generic:
                      - generic:
                        - button "動画を再生" [ref=f277e10] [cursor=pointer]
                        - button "プレーヤー コントロールを非表示にする" [ref=f277e12] [cursor=pointer]
                        - generic [ref=f277e14]:
                          - generic [ref=f277e19]:
                            - generic [ref=f277e20]:
                              - link "BambuLab of CNC Milling? Makera Carvera Air Desktop Mill Reviewed" [ref=f277e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=WR7ROCYbwcc
                              - link "My Tech Fun" [ref=f277e22] [cursor=pointer]:
                                - /url: /channel/UC6QckhILSqdl3K0TWPWrDdg
                                - generic [ref=f277e23]: My Tech Fun
                            - generic [ref=f277e24]:
                              - button [ref=f277e25] [cursor=pointer]
                              - generic [ref=f277e27]:
                                - generic: My Tech Fun
                                - generic: チャンネル登録者数 9.19万人
                          - generic [ref=f277e28]:
                            - button "共有" [ref=f277e31] [cursor=pointer]:
                              - generic [ref=f277e35]:
                                - img
                            - link "YouTube で見る" [ref=f277e42] [cursor=pointer]:
                              - /url: https://www.youtube.com/watch?v=WR7ROCYbwcc
                              - generic [ref=f277e45]:
                                - text: 見る
                                - img [ref=f277e47]:
            ...
            - generic [ref=e591] [cursor=pointer]:
              ...
              - iframe [ref=e654]:
                - generic [active] [ref=f279e1]:
                  - generic "YouTube 動画プレーヤー" [ref=f279e3]
                  - generic [ref=f279e5]:
                    - generic:
                      - generic:
                        - button "動画を再生" [ref=f279e10] [cursor=pointer]
                        - button "プレーヤー コントロールを非表示にする" [ref=f279e12] [cursor=pointer]
                        - generic [ref=f279e14]:
                          - generic [ref=f279e19]:
                            - generic [ref=f279e20]:
                              - link "How I Made My Own iPhone from a Block of Aluminum" [ref=f279e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=Yrl4OmS3bBA
                              - link "Strange Parts" [ref=f279e22] [cursor=pointer]:
                                - /url: /channel/UCO8DQrSp5yEP937qNqTooOw
                                - generic [ref=f279e23]: Strange Parts
                            - generic [ref=f279e24]:
                              - button [ref=f279e25] [cursor=pointer]
                              - generic [ref=f279e27]:
                                - generic: Strange Parts
                                - generic: チャンネル登録者数 196万人
                          - generic [ref=f279e28]:
                            - button "共有" [ref=f279e31] [cursor=pointer]:
                              - generic [ref=f279e35]:
                                - img
                            - link "YouTube で見る" [ref=f279e42] [cursor=pointer]:
                              - /url: https://www.youtube.com/watch?v=Yrl4OmS3bBA
                              - generic [ref=f279e45]:
                                - text: 見る
                                - img [ref=f279e47]:
            ...
            - generic [ref=e667] [cursor=pointer]:
              ...
              - iframe [ref=e730]:
                - generic [active] [ref=f281e1]:
                  - generic "YouTube 動画プレーヤー" [ref=f281e3]
                  - generic [ref=f281e5]:
                    - generic:
                      - generic:
                        - button "動画を再生" [ref=f281e10] [cursor=pointer]
                        - button "プレーヤー コントロールを非表示にする" [ref=f281e12] [cursor=pointer]
                        - generic [ref=f281e14]:
                          - generic [ref=f281e19]:
                            - generic [ref=f281e20]:
                              - link "The BEST 4 Axis Desktop CNC Machine?" [ref=f281e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=ffZlPlssL-s
                              - link "TAOW" [ref=f281e22] [cursor=pointer]:
                                - /url: /channel/UCpV7D0LoRbYhdx2G-whWyog
                                - generic [ref=f281e23]: TAOW
                            - generic [ref=f281e24]:
                              - button [ref=f281e25] [cursor=pointer]
                              - generic [ref=f281e27]:
                                - generic: TAOW
                                - generic: チャンネル登録者数 26.4万人
                          - generic [ref=f281e28]:
                            - button "共有" [ref=f281e31] [cursor=pointer]:
                              - generic [ref=f281e35]:
                                - img
                            - link "YouTube で見る" [ref=f281e42] [cursor=pointer]:
                              - /url: https://www.youtube.com/watch?v=ffZlPlssL-s
                              - generic [ref=f281e45]:
                                - text: 見る
                                - img [ref=f281e47]:
          ...
          - generic [ref=e741]:
            - generic [ref=e743] [cursor=pointer]:
              - img [ref=e744]
              - iframe [ref=e806]:
                - generic [active] [ref=f283e1]:
                  - generic "YouTube 動画プレーヤー" [ref=f283e3]
                  - generic [ref=f283e5]:
                    - generic:
                      - generic:
                        - button "動画を再生" [ref=f283e10] [cursor=pointer]
                        - button "プレーヤー コントロールを非表示にする" [ref=f283e12] [cursor=pointer]
                        - generic [ref=f283e14]:
                          - generic [ref=f283e19]:
                            - generic [ref=f283e20]:
                              - link "Makera Carvera Auto Tool Changer Benchtop CNC machine, In-depth review, aluminum cutting stress test" [ref=f283e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=zN7eEzAqI3A
                              - link "Aurora Tech" [ref=f283e22] [cursor=pointer]:
                                - /url: /channel/UCGER4yfUXubhNVPYoNzBSEA
                                - generic [ref=f283e23]: Aurora Tech
                            - generic [ref=f283e24]:
                              - button [ref=f283e25] [cursor=pointer]
                              - generic [ref=f283e27]:
                                - generic: Aurora Tech
                                - generic: チャンネル登録者数 12.4万人
                          - generic [ref=f283e28]:
                            - button "共有" [ref=f283e31] [cursor=pointer]:
                              - generic [ref=f283e35]:
                                - img
                            - link "YouTube で見る" [ref=f283e42] [cursor=pointer]:
                              - /url: https://www.youtube.com/watch?v=zN7eEzAqI3A
                              - generic [ref=f283e45]:
                                - text: 見る
                                - img [ref=f283e47]:
  ...
  - generic:
    - generic:
      - generic [ref=e1092]:
        - iframe [ref=e1093]:
          - button "会社からのメッセージを閉じる" [ref=f287e3] [cursor=pointer]:
            - img [ref=f287e4]
        - iframe [ref=e1094]:
          - button "Hi. Need any help?" [ref=f288e4] [cursor=pointer]
      - iframe [ref=e1095]:
        - button "メッセージングウィンドウを開く" [ref=f289e4] [cursor=pointer]:
          - img [ref=f289e6]
          - img [ref=f289e9]
  - generic [ref=e1097]:
    - generic [ref=e1100]:
...
> 53  |       expect(page.url()).toContain('/products/');
  ...
  93  |           break;
  94  |         } catch {
  95  |           if (page.url().includes('/cart/add')) {
  96  |             console.warn(`[Global] ⚠️ 页面已跳转到 /cart/add 错误页，执行 AJAX API 兜底加购`);
  97  |             const added = await addToCartViaApi(page, TARGET_URL);
  98  |             expect(added).toBe(true);
  99  |             // 返回商品页恢复现场，再关闭弹窗
  100 |             await page.goto(TARGET_URL, { waitUntil: 'domcontentloaded', timeout: 120000 });
  101 |             await dismissAllPopups(page);
  102 |             // 通过顶部购物车图标打开抽屉（同域已有购物车商品，Dawn 主题会弹出 cart-drawer）
  103 |             const cartIcon = page.locator('a[href="/cart"]').first();
  104 |             await expect(page.getByText('New Launch! The Makera Z1 Pre-Order Is Live.').first()).toBeVisible({ timeout: 5000 });
  105 |             await cartIcon.click({ timeout: 10000 }).catch(() => {});
  106 |             await page.waitForTimeout(2000);
  107 |             await expect(cartDrawer).toBeVisible({ timeout: 15000 });
  108 |             break;
  109 |           }
  110 |           console.warn(`[Global] ⚠️ 第${attempt}轮：购物车抽屉未弹出，清理浮窗后重新点击加购`);
  111 |           if (attempt === 2) throw new Error('[Global] 加购后购物车抽屉未弹出（共点击 2 次）');
  112 |           await dismissAllPopups(page);
  113 |           await expect(page.getByText('New Launch! The Makera Z1 Pre-Order Is Live.').first()).toBeVisible({ timeout: 5000 });
  114 |           await addToCartBtn.click({ timeout: 8000 }).catch(() => {});
  115 |         }
  116 |       }
  117 |       console.log(`[Global] ✅ 购物车抽屉已弹出`);
  118 | 
  119 |       // 定位方式：限定在购物车抽屉（dialog）内用 getByRole 定位商品链接
  120 |       // （页面导航菜单中也存在同名隐藏文本，不限定范围会被 .first() 误匹配）
  121 |       const productInCart = cartDrawer.getByRole('link', { name: PRODUCT_NAME }).first();
  122 |       await expect(productInCart).toBeVisible({ timeout: 10000 });
  123 |       console.log(`[Global] ✅ 购物车中存在目标商品: ${PRODUCT_NAME}`);
  124 |     });
  125 |   });
  126 | 
  127 |   test('商品正常进入结算页', async ({ sharedPage: page }) => {
  128 |     // ── Allure 报告信息：运行参数 + 预期结果 ──
  129 |     parameter('TARGET_URL', TARGET_URL);
  130 |     parameter('PRODUCT_NAME', PRODUCT_NAME);
  131 |     parameter('地区/语言', REGION);
  132 |     test.info().annotations.push(
  133 |       { type: '预期结果', description: '点击 Check out 后跳转结算页 /checkouts/，且订单摘要含目标商品' },
  134 |       { type: '前置条件', description: '上一用例已加购成功，购物车抽屉处于弹出状态（沿用页面现场）' },
  135 |     );
  136 | 
  137 |     // ========== 阶段1：前置检查（确认上一用例已加购成功） ==========
  138 |     // 严格断言 dialog 角色：顶部导航的 "My Cart" 文本会让 getByText 误报
  139 |     const cartDrawer = page.getByRole('dialog', { name: /my cart/i }).first();
  140 |     await test.step('前置检查：购物车抽屉处于弹出状态', async () => {
  141 |       // 本用例直接沿用上一用例的页面现场，不重新初始化、不重新加购
  142 |       await expect(cartDrawer).toBeVisible({ timeout: 15000 });
  143 |       console.log(`[Global] ✅ 购物车抽屉已弹出，直接开始点击 Check Out`);
  144 |     });
  145 | 
  146 |     // ========== 阶段2：点击 Check out 按钮进入结算页 ==========
  147 |     await test.step('弹窗清理并点击 Check out 按钮', async () => {
  148 |       // 定位方式：限定在购物车抽屉（dialog）内匹配 "Check out"
  149 |       // （该控件在不同渲染状态下可能是 button 或 link 角色，用逗号选择器兼容两种形态）
  150 |       const checkOutBtn = cartDrawer.locator('button, a').getByText(/check\s*out/i).first();
  151 |       await expect(checkOutBtn).toBeVisible({ timeout: 10000 });
  152 |       console.log(`[Global] ✅ Check Out 按钮可见，准备进入结算页`);
  153 |       // 循环最多 3 轮：每轮先关闭全部浮窗再点击（单次点击限时 8s，防遮挡时长时间自动滚动重试）
```