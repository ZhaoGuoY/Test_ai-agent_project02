...
- Name: smoke/eu_carvera.spec.ts >> EU 站点 >> 商品加入购物车
...
Received string:    "https://www.makera.com/?utm_source=Makera+EU"
```
...
- generic [active] [ref=e1]:
        ...
        - generic [ref=e512]:
          - generic [ref=e514]:
            - generic [ref=e516] [cursor=pointer]:
              - img [ref=e517]
              - iframe [ref=e579]:
                - generic [active] [ref=f224e1]:
                  - generic "YouTube Video Player" [ref=f224e3]
                  - generic [ref=f224e5]:
                    - generic:
                      - generic:
                        - button "Play video" [ref=f224e10] [cursor=pointer]
                        - button "Hide player controls" [ref=f224e12] [cursor=pointer]
                        - generic [ref=f224e14]:
                          - generic [ref=f224e19]:
                            - generic [ref=f224e20]:
                              - link "BambuLab of CNC Milling? Makera Carvera Air Desktop Mill Reviewed" [ref=f224e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=WR7ROCYbwcc
                              - link "My Tech Fun" [ref=f224e22] [cursor=pointer]:
                                - /url: /channel/UC6QckhILSqdl3K0TWPWrDdg
                                - generic [ref=f224e23]: My Tech Fun
                            - generic [ref=f224e24]:
                              - button [ref=f224e25] [cursor=pointer]
                              - generic [ref=f224e27]:
                                - generic: My Tech Fun
                                - generic: 91.9K subscribers
                          - generic [ref=f224e28]:
                            - button "Share" [ref=f224e31] [cursor=pointer]:
                              - generic [ref=f224e35]:
                                - img
                            - link "Watch on YouTube" [ref=f224e42] [cursor=pointer]:
                              - /url: https://www.youtube.com/watch?v=WR7ROCYbwcc
                              - generic [ref=f224e45]:
                                - text: Watch on
                                - img [ref=f224e47]:
          ...
          - generic [ref=e589]:
            - generic [ref=e591] [cursor=pointer]:
              - img [ref=e592]
              - iframe [ref=e654]:
                - generic [active] [ref=f226e1]:
                  - generic "YouTube Video Player" [ref=f226e3]
                  - generic [ref=f226e5]:
                    - generic:
                      - generic:
                        - button "Play video" [ref=f226e10] [cursor=pointer]
                        - button "Hide player controls" [ref=f226e12] [cursor=pointer]
                        - generic [ref=f226e14]:
                          - generic [ref=f226e19]:
                            - generic [ref=f226e20]:
                              - link "How I Made My Own iPhone from a Block of Aluminum" [ref=f226e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=Yrl4OmS3bBA
                              - link "Strange Parts" [ref=f226e22] [cursor=pointer]:
                                - /url: /channel/UCO8DQrSp5yEP937qNqTooOw
                                - generic [ref=f226e23]: Strange Parts
                            - generic [ref=f226e24]:
                              - button [ref=f226e25] [cursor=pointer]
                              - generic [ref=f226e27]:
                                - generic: Strange Parts
                                - generic: 1.96M subscribers
                          - generic [ref=f226e28]:
                            - button "Share" [ref=f226e31] [cursor=pointer]:
                              - generic [ref=f226e35]:
                                - img
                            - link "Watch on YouTube" [ref=f226e42] [cursor=pointer]:
                              - /url: https://www.youtube.com/watch?v=Yrl4OmS3bBA
                              - generic [ref=f226e45]:
                                - text: Watch on
                                - img [ref=f226e47]:
          ...
          - generic [ref=e665]:
            - generic [ref=e667] [cursor=pointer]:
              - img [ref=e668]
              - iframe [ref=e730]:
                - generic [active] [ref=f228e1]:
                  - generic "YouTube Video Player" [ref=f228e3]
                  - generic [ref=f228e5]:
                    - generic:
                      - generic:
                        - button "Play video" [ref=f228e10] [cursor=pointer]
                        - button "Hide player controls" [ref=f228e12] [cursor=pointer]
                        - generic [ref=f228e14]:
                          - generic [ref=f228e19]:
                            - generic [ref=f228e20]:
                              - link "The BEST 4 Axis Desktop CNC Machine?" [ref=f228e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=ffZlPlssL-s
                              - link "TAOW" [ref=f228e22] [cursor=pointer]:
                                - /url: /channel/UCpV7D0LoRbYhdx2G-whWyog
                                - generic [ref=f228e23]: TAOW
                            - generic [ref=f228e24]:
                              - button [ref=f228e25] [cursor=pointer]
                              - generic [ref=f228e27]:
                                - generic: TAOW
                                - generic: 264K subscribers
                          - generic [ref=f228e28]:
                            - button "Share" [ref=f228e31] [cursor=pointer]:
                              - generic [ref=f228e35]:
                                - img
                            - link "Watch on YouTube" [ref=f228e42] [cursor=pointer]:
                              - /url: https://www.youtube.com/watch?v=ffZlPlssL-s
                              - generic [ref=f228e45]:
                                - text: Watch on
                                - img [ref=f228e47]:
          ...
          - generic [ref=e741]:
            - generic [ref=e743] [cursor=pointer]:
              - img [ref=e744]
              - iframe [ref=e806]:
                - generic [active] [ref=f230e1]:
                  - generic "YouTube Video Player" [ref=f230e3]
                  - generic [ref=f230e5]:
                    - generic:
                      - generic:
                        - button "Play video" [ref=f230e10] [cursor=pointer]
                        - button "Hide player controls" [ref=f230e12] [cursor=pointer]
                        - generic [ref=f230e14]:
                          - generic [ref=f230e19]:
                            - generic [ref=f230e20]:
                              - link "Makera Carvera Auto Tool Changer Benchtop CNC machine, In-depth review, aluminum cutting stress test" [ref=f230e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=zN7eEzAqI3A
                              - link "Aurora Tech" [ref=f230e22] [cursor=pointer]:
                                - /url: /channel/UCGER4yfUXubhNVPYoNzBSEA
                                - generic [ref=f230e23]: Aurora Tech
                            - generic [ref=f230e24]:
                              - button [ref=f230e25] [cursor=pointer]
                              - generic [ref=f230e27]:
                                - generic: Aurora Tech
                                - generic: 124K subscribers
                          - generic [ref=f230e28]:
                            - button "Share" [ref=f230e31] [cursor=pointer]:
                              - generic [ref=f230e35]:
                                - img
                            - link "Watch on YouTube" [ref=f230e42] [cursor=pointer]:
                              - /url: https://www.youtube.com/watch?v=zN7eEzAqI3A
                              - generic [ref=f230e45]:
                                - text: Watch on
                                - img [ref=f230e47]:
  ...
  - generic:
    - generic:
      - generic [ref=e1092]:
        - iframe [ref=e1093]:
          - button "Close message from company" [ref=f234e3] [cursor=pointer]:
            - img [ref=f234e4]
        - iframe [ref=e1094]:
          - button "Hi. Need any help?" [ref=f235e4] [cursor=pointer]
      - iframe [ref=e1095]:
        - button "Open messaging window" [ref=f236e4] [cursor=pointer]:
          - img [ref=f236e6]
          - img [ref=f236e9]
  - generic [ref=e1097]:
    - generic [ref=e1100]:
...
```ts
  ...
  50  |       // 验证 URL 包含 /products/（URL 字符串断言）
> 51  |       expect(page.url()).toContain('/products/');
      |                          ^ Error: expect(received).toContain(expected) // indexOf
  52  |     });
  53  | 
  54  |     // ========== 阶段2：等待渲染 + 弹窗清理 + 点击 Add to cart ==========
  55  |     // 定位方式：CSS 类名定位 product-form__submit（Shopify 商品表单内的真实加购按钮）
  56  |     // 页面存在多个 sticky-add-cart-btn 悬浮按钮，顶部时位于视口外，用文本定位会误匹配导致点击卡住
  57  |     const addToCartBtn = page.locator('button.product-form__submit[name="add"]').first();
  58  |     await test.step('弹窗清理并点击 Add to cart 按钮', async () => {
  59  |       console.log(`[EU] ✅ Add to cart 按钮可见，准备点击加购`);
  60  |       // 点击前等待 5s：给浮窗/懒加载元素渲染时间，便于一次性清理
  61  |       await page.waitForTimeout(5000);
  62  |       // 循环最多 3 轮：每轮先关闭全部浮窗（幸运转盘/翻译弹窗/客服悬浮/意外下拉），
  63  |       // 再滚动+点击。单次点击限时 8s，避免被遮挡时 Playwright 长时间自动滚动重试（页面上下滑动）
  64  |       for (let attempt = 1; attempt <= 3; attempt++) {
  65  |         // 先按 Escape 关闭意外展开的下拉浮窗，再清理所有已知浮窗（无论是否存在都安全执行，失败不阻断）
  66  |         await page.keyboard.press('Escape').catch(() => {});
  67  |         await page.waitForTimeout(300);
  68  |         await dismissAllPopups(page);
  69  |         try {
  70  |           // 按钮位于首屏下方，显式滚动到按钮位置后再点击（timeout 防继承测试级 300s）
  71  |           await addToCartBtn.click({ timeout: 8000 });
  72  |           break;
  73  |         } catch {
  74  |           console.warn(`[EU] ⚠️ 第${attempt}轮点击失败（可能被浮窗遮挡），重新清理后重试`);
  75  |           if (attempt === 3) throw new Error('[EU] Add to cart 按钮 3 轮点击均失败');
  76  |         }
  77  |       }
  78  |       console.log(`[EU] 🛒 已点击 Add to cart，等待购物车抽屉弹出...`);
  79  |     });
  80  | 
  81  |     // ========== 阶段3：断言加购成功（抽屉弹出且目标商品存在） ==========
  82  |     await test.step('断言购物车抽屉弹出且含目标商品', async () => {
  83  |       // 定位方式：getByRole('dialog') 严格断言抽屉本体。
  84  |       // 注意：顶部导航购物车图标文本也是 "My Cart"，用 getByText(/my cart/i) 会在抽屉未弹出时误报
  85  |       const cartDrawer = page.getByRole('dialog', { name: /my cart/i }).first();
  86  |       // 抽屉未弹出（可能被浮窗遮挡/动画打断）时清理浮窗后重新点击加购，最多 2 轮；
  87  |       // 若页面已被导航到 Shopify /cart/add 错误页（半渲染时原生表单 POST 缺 items 参数被拒）
  88  |       // 或已点击 2 次但抽屉始终未弹出，则停止 UI 重试，改走 AJAX API 兜底加购 →
  89  |       // 返回商品页 → 打开购物车抽屉
  90  |       for (let attempt = 1; attempt <= 2; attempt++) {
  91  |         try {
  92  |           await expect(cartDrawer).toBeVisible({ timeout: 15_000 });
  93  |           break;
  94  |         } catch {
  95  |           const onCartAddErrorPage = page.url().includes('/cart/add');
  96  |           if (onCartAddErrorPage || attempt === 2) {
  97  |             const reason = onCartAddErrorPage
  98  |               ? '页面已跳转到 /cart/add 错误页'
  99  |               : '已点击 2 次但购物车抽屉始终未弹出（点击可能被页面 JS 拦截，改走 API 加购）';
  100 |             console.warn(`[EU] ⚠️ ${reason}，执行 AJAX API 兜底加购`);
  101 |             const added = await addToCartViaApi(page, TARGET_URL);
  102 |             expect(added).toBe(true);
  103 |             // 返回商品页恢复现场，再关闭弹窗
  104 |             await page.goto(TARGET_URL, { waitUntil: 'domcontentloaded', timeout: 120000 });
  105 |             await dismissAllPopups(page);
  106 |             // 通过顶部购物车图标打开抽屉（同域已有购物车商品，Dawn 主题会弹出 cart-drawer）
  107 |             const cartIcon = page.locator('a[href="/cart"]').first();
  ...
  111 |             break;
  112 |           }
  113 |           console.warn(`[EU] ⚠️ 第${attempt}轮：购物车抽屉未弹出，清理浮窗后重新点击加购`);
  ...
  125 |       console.log(`[EU] ✅ 购物车中存在目标商品: ${PRODUCT_NAME}`);
  126 |     });
  127 |   });
  128 | 
  ...
  145 |       console.log(`[EU] ✅ 购物车抽屉已弹出，直接开始点击 Check Out`);
  146 |     });
  147 | 
