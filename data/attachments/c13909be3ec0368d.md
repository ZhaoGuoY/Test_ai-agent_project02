...
- generic [active] [ref=e1]:
        ...
        - generic [ref=e511]:
          - generic [ref=e513]:
            - generic [ref=e515] [cursor=pointer]:
              - img [ref=e516]
              - iframe [ref=e578]:
                - generic [active] [ref=f382e1]:
                  - generic "YouTube 動画プレーヤー" [ref=f382e3]
                  - generic [ref=f382e5]:
                    - generic:
                      - generic:
                        - button "動画を再生" [ref=f382e10] [cursor=pointer]
                        - button "プレーヤー コントロールを非表示にする" [ref=f382e12] [cursor=pointer]
                        - generic [ref=f382e14]:
                          - generic [ref=f382e19]:
                            - generic [ref=f382e20]:
                              - link "BambuLab of CNC Milling? Makera Carvera Air Desktop Mill Reviewed" [ref=f382e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=WR7ROCYbwcc
                              - link "My Tech Fun" [ref=f382e22] [cursor=pointer]:
                                - /url: /channel/UC6QckhILSqdl3K0TWPWrDdg
                                - generic [ref=f382e23]: My Tech Fun
                            - generic [ref=f382e24]:
                              - button [ref=f382e25] [cursor=pointer]
                              - generic [ref=f382e27]:
                                - generic: My Tech Fun
                                - generic: チャンネル登録者数 9.19万人
                          - generic [ref=f382e28]:
                            - button "共有" [ref=f382e31] [cursor=pointer]:
                              - generic [ref=f382e35]:
                                - img
                            - link "YouTube で見る" [ref=f382e42] [cursor=pointer]:
                              - /url: https://www.youtube.com/watch?v=WR7ROCYbwcc
                              - generic [ref=f382e45]:
                                - text: 見る
                                - img [ref=f382e47]:
          ...
          - generic [ref=e588]:
            - generic [ref=e590] [cursor=pointer]:
              - img [ref=e591]
              - iframe [ref=e653]:
                - generic [active] [ref=f384e1]:
                  - generic "YouTube 動画プレーヤー" [ref=f384e3]
                  - generic [ref=f384e5]:
                    - generic:
                      - generic:
                        - button "動画を再生" [ref=f384e10] [cursor=pointer]
                        - button "プレーヤー コントロールを非表示にする" [ref=f384e12] [cursor=pointer]
                        - generic [ref=f384e14]:
                          - generic [ref=f384e19]:
                            - generic [ref=f384e20]:
                              - link "How I Made My Own iPhone from a Block of Aluminum" [ref=f384e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=Yrl4OmS3bBA
                              - link "Strange Parts" [ref=f384e22] [cursor=pointer]:
                                - /url: /channel/UCO8DQrSp5yEP937qNqTooOw
                                - generic [ref=f384e23]: Strange Parts
                            - generic [ref=f384e24]:
                              - button [ref=f384e25] [cursor=pointer]
                              - generic [ref=f384e27]:
                                - generic: Strange Parts
                                - generic: チャンネル登録者数 196万人
                          - generic [ref=f384e28]:
                            - button "共有" [ref=f384e31] [cursor=pointer]:
                              - generic [ref=f384e35]:
                                - img
                            - link "YouTube で見る" [ref=f384e42] [cursor=pointer]:
                              - /url: https://www.youtube.com/watch?v=Yrl4OmS3bBA
                              - generic [ref=f384e45]:
                                - text: 見る
                                - img [ref=f384e47]:
                    ...
                    - generic:
                      - generic:
                        ...
                        - generic [ref=f386e14]:
                          - generic [ref=f386e19]:
                            - generic [ref=f386e20]:
                              - link "The BEST 4 Axis Desktop CNC Machine?" [ref=f386e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=ffZlPlssL-s
                              - link "TAOW" [ref=f386e22] [cursor=pointer]:
                                - /url: /channel/UCpV7D0LoRbYhdx2G-whWyog
                                - generic [ref=f386e23]: TAOW
                            - generic [ref=f386e24]:
                    ...
                    - generic:
                      - generic:
                        ...
                        - generic [ref=f388e14]:
                          - generic [ref=f388e19]:
                            - generic [ref=f388e20]:
                              - link "Makera Carvera Auto Tool Changer Benchtop CNC machine, In-depth review, aluminum cutting stress test" [ref=f388e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=zN7eEzAqI3A
                              - link "Aurora Tech" [ref=f388e22] [cursor=pointer]:
                                - /url: /channel/UCGER4yfUXubhNVPYoNzBSEA
                                - generic [ref=f388e23]: Aurora Tech
                            - generic [ref=f388e24]:
  ...
  - generic:
    - generic:
      - generic [ref=e1091]:
        - iframe [ref=e1092]:
          - button "会社からのメッセージを閉じる" [ref=f393e3] [cursor=pointer]:
            - img [ref=f393e4]
        - iframe [ref=e1093]:
          - button "Hi. Need any help?" [ref=f394e4] [cursor=pointer]
      - iframe [ref=e1094]:
        - button "メッセージングウィンドウを開く" [ref=f395e4] [cursor=pointer]:
          - img [ref=f395e6]
          - img [ref=f395e9]
  - generic [ref=e1096]:
    - generic [ref=e1099]:
