...
- generic [active] [ref=e1]:
        ...
        - generic [ref=e512]:
            ...
            - generic [ref=e516] [cursor=pointer]:
              ...
              - iframe [ref=e579]:
                - generic [active] [ref=f375e1]:
                  - generic "YouTube 動画プレーヤー" [ref=f375e3]
                  - generic [ref=f375e5]:
                    - generic:
                      - generic:
                        - button "動画を再生" [ref=f375e10] [cursor=pointer]
                        - button "プレーヤー コントロールを非表示にする" [ref=f375e12] [cursor=pointer]
                        - generic [ref=f375e14]:
                          - generic [ref=f375e19]:
                            - generic [ref=f375e20]:
                              - link "BambuLab of CNC Milling? Makera Carvera Air Desktop Mill Reviewed" [ref=f375e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=WR7ROCYbwcc
                              - link "My Tech Fun" [ref=f375e22] [cursor=pointer]:
                                - /url: /channel/UC6QckhILSqdl3K0TWPWrDdg
                                - generic [ref=f375e23]: My Tech Fun
                            - generic [ref=f375e24]:
                              - button [ref=f375e25] [cursor=pointer]
                              - generic [ref=f375e27]:
                                - generic: My Tech Fun
                                - generic: チャンネル登録者数 9.19万人
                          - generic [ref=f375e28]:
                            - button "共有" [ref=f375e31] [cursor=pointer]:
                              - generic [ref=f375e35]:
                                - img
                            - link "YouTube で見る" [ref=f375e42] [cursor=pointer]:
                              - /url: https://www.youtube.com/watch?v=WR7ROCYbwcc
                              - generic [ref=f375e45]:
                                - text: 見る
                                - img [ref=f375e47]:
          ...
          - generic [ref=e589]:
            - generic [ref=e591] [cursor=pointer]:
              - img [ref=e592]
              - iframe [ref=e654]:
                - generic [active] [ref=f377e1]:
                  - generic "YouTube 動画プレーヤー" [ref=f377e3]
                  - generic [ref=f377e5]:
                    - generic:
                      - generic:
                        - button "動画を再生" [ref=f377e10] [cursor=pointer]
                        - button "プレーヤー コントロールを非表示にする" [ref=f377e12] [cursor=pointer]
                        - generic [ref=f377e14]:
                          - generic [ref=f377e19]:
                            - generic [ref=f377e20]:
                              - link "How I Made My Own iPhone from a Block of Aluminum" [ref=f377e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=Yrl4OmS3bBA
                              - link "Strange Parts" [ref=f377e22] [cursor=pointer]:
                                - /url: /channel/UCO8DQrSp5yEP937qNqTooOw
                                - generic [ref=f377e23]: Strange Parts
                            - generic [ref=f377e24]:
                              - button [ref=f377e25] [cursor=pointer]
                              - generic [ref=f377e27]:
                                - generic: Strange Parts
                                - generic: チャンネル登録者数 196万人
                          - generic [ref=f377e28]:
                            - button "共有" [ref=f377e31] [cursor=pointer]:
                              - generic [ref=f377e35]:
                                - img
                            - link "YouTube で見る" [ref=f377e42] [cursor=pointer]:
                              - /url: https://www.youtube.com/watch?v=Yrl4OmS3bBA
                              - generic [ref=f377e45]:
                                - text: 見る
                                - img [ref=f377e47]:
            ...
            - generic [ref=e667] [cursor=pointer]:
              ...
              - iframe [ref=e730]:
                - generic [active] [ref=f379e1]:
                  - generic "YouTube 動画プレーヤー" [ref=f379e3]
                  - generic [ref=f379e5]:
                    - generic:
                      - generic:
                        - button "動画を再生" [ref=f379e10] [cursor=pointer]
                        - button "プレーヤー コントロールを非表示にする" [ref=f379e12] [cursor=pointer]
                        - generic [ref=f379e14]:
                          - generic [ref=f379e19]:
                            - generic [ref=f379e20]:
                              - link "The BEST 4 Axis Desktop CNC Machine?" [ref=f379e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=ffZlPlssL-s
                              - link "TAOW" [ref=f379e22] [cursor=pointer]:
                                - /url: /channel/UCpV7D0LoRbYhdx2G-whWyog
                                - generic [ref=f379e23]: TAOW
                            - generic [ref=f379e24]:
                              - button [ref=f379e25] [cursor=pointer]
                              - generic [ref=f379e27]:
                                - generic: TAOW
                                - generic: チャンネル登録者数 26.4万人
                          - generic [ref=f379e28]:
                            - button "共有" [ref=f379e31] [cursor=pointer]:
                              - generic [ref=f379e35]:
                                - img
                            - link "YouTube で見る" [ref=f379e42] [cursor=pointer]:
                              - /url: https://www.youtube.com/watch?v=ffZlPlssL-s
                              - generic [ref=f379e45]:
                                - text: 見る
                                - img [ref=f379e47]:
          ...
          - generic [ref=e741]:
            - generic [ref=e743] [cursor=pointer]:
              - img [ref=e744]
              - iframe [ref=e806]:
                - generic [active] [ref=f381e1]:
                  - generic "YouTube 動画プレーヤー" [ref=f381e3]
                  - generic [ref=f381e5]:
                    - generic:
                      - generic:
                        - button "動画を再生" [ref=f381e10] [cursor=pointer]
                        - button "プレーヤー コントロールを非表示にする" [ref=f381e12] [cursor=pointer]
                        - generic [ref=f381e14]:
                          - generic [ref=f381e19]:
                            - generic [ref=f381e20]:
                              - link "Makera Carvera Auto Tool Changer Benchtop CNC machine, In-depth review, aluminum cutting stress test" [ref=f381e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=zN7eEzAqI3A
                              - link "Aurora Tech" [ref=f381e22] [cursor=pointer]:
                                - /url: /channel/UCGER4yfUXubhNVPYoNzBSEA
                                - generic [ref=f381e23]: Aurora Tech
                            - generic [ref=f381e24]:
                              - button [ref=f381e25] [cursor=pointer]
                              - generic [ref=f381e27]:
                                - generic: Aurora Tech
                                - generic: チャンネル登録者数 12.4万人
                          - generic [ref=f381e28]:
                            - button "共有" [ref=f381e31] [cursor=pointer]:
                              - generic [ref=f381e35]:
                                - img
                            - link "YouTube で見る" [ref=f381e42] [cursor=pointer]:
                              - /url: https://www.youtube.com/watch?v=zN7eEzAqI3A
                              - generic [ref=f381e45]:
                                - text: 見る
                                - img [ref=f381e47]:
  ...
  - generic:
    - generic:
      - generic [ref=e1092]:
        - iframe [ref=e1093]:
          - button "会社からのメッセージを閉じる" [ref=f385e3] [cursor=pointer]:
            - img [ref=f385e4]
        - iframe [ref=e1094]:
          - button "Hi. Need any help?" [ref=f386e4] [cursor=pointer]
      - iframe [ref=e1095]:
        - button "メッセージングウィンドウを開く" [ref=f387e4] [cursor=pointer]:
          - img [ref=f387e6]
          - img [ref=f387e9]
  - generic [ref=e1097]:
    - generic [ref=e1100]:
...
> 53  |       expect(page.url()).toContain('/products/');
  ...
  61  |       await expect(addToCartBtn).toBeVisible({ timeout: 10000 });
  62  |       console.log(`[Global] ✅ Add to cart 按钮可见，准备点击加购`);
  63  |       // 点击前等待 5s：给浮窗/懒加载元素渲染时间，便于一次性清理
  64  |       await page.waitForTimeout(5000);
  65  |       // 循环最多 3 轮：每轮先关闭全部浮窗（幸运转盘/翻译弹窗/客服悬浮/意外下拉），
  66  |       // 再滚动+点击。单次点击限时 8s，避免被遮挡时 Playwright 长时间自动滚动重试（页面上下滑动）
  67  |       for (let attempt = 1; attempt <= 3; attempt++) {
  68  |         // 先按 Escape 关闭意外展开的下拉浮窗，再清理所有已知浮窗（无论是否存在都安全执行，失败不阻断）
  69  |         await page.keyboard.press('Escape').catch(() => {});
  70  |         await page.waitForTimeout(300);
  71  |         await dismissAllPopups(page);
  72  |         try {
  73  |           // 按钮位于首屏下方，显式滚动到按钮位置后再点击（timeout 防继承测试级 300s）
  74  |           await addToCartBtn.scrollIntoViewIfNeeded({ timeout: 10000 });
  75  |           await addToCartBtn.click({ timeout: 8000 });
  76  |           break;
  77  |         } catch {
  78  |           console.warn(`[Global] ⚠️ 第${attempt}轮点击失败（可能被浮窗遮挡），重新清理后重试`);
  79  |           if (attempt === 3) throw new Error('[Global] Add to cart 按钮 3 轮点击均失败');
  80  |         }
  81  |       }
  82  |       console.log(`[Global] 🛒 已点击 Add to cart，等待购物车抽屉弹出...`);
  83  |     });
  84  | 
  85  |     // ========== 阶段3：断言加购成功（抽屉弹出且目标商品存在） ==========
  86  |     await test.step('断言购物车抽屉弹出且含目标商品', async () => {
  87  |       // 定位方式：getByRole('dialog') 严格断言抽屉本体。
  88  |       // 注意：顶部导航购物车图标文本也是 "My Cart"，用 getByText(/my cart/i) 会在抽屉未弹出时误报
  89  |       const cartDrawer = page.getByRole('dialog', { name: /my cart/i }).first();
  90  |       // 抽屉未弹出（可能被浮窗遮挡/动画打断）时清理浮窗后重新点击加购，最多 2 轮；
  91  |       // 若页面已被导航到 Shopify /cart/add 错误页（半渲染时原生表单 POST 缺 items 参数被拒），
  92  |       // 则停止 UI 重试，改走 AJAX API 兜底加购 → 返回商品页 → 打开购物车抽屉
  93  |       for (let attempt = 1; attempt <= 2; attempt++) {
  94  |         try {
  95  |           await expect(cartDrawer).toBeVisible({ timeout: 15000 });
  96  |           break;
  97  |         } catch {
  98  |           if (page.url().includes('/cart/add')) {
  99  |             console.warn(`[Global] ⚠️ 页面已跳转到 /cart/add 错误页，执行 AJAX API 兜底加购`);
  100 |             const added = await addToCartViaApi(page, TARGET_URL);
  101 |             expect(added).toBe(true);
  102 |             // 返回商品页恢复现场，再关闭弹窗
  103 |             await page.goto(TARGET_URL, { waitUntil: 'domcontentloaded', timeout: 120000 });
  104 |             await dismissAllPopups(page);
  105 |             // 通过顶部购物车图标打开抽屉（同域已有购物车商品，Dawn 主题会弹出 cart-drawer）
  106 |             const cartIcon = page.locator('a[href="/cart"]').first();
  107 |             await cartIcon.scrollIntoViewIfNeeded({ timeout: 10000 }).catch(() => {});
  108 |             await cartIcon.click({ timeout: 10000 }).catch(() => {});
  109 |             await page.waitForTimeout(2000);
  110 |             await expect(cartDrawer).toBeVisible({ timeout: 15000 });
  111 |             break;
  112 |           }
  113 |           console.warn(`[Global] ⚠️ 第${attempt}轮：购物车抽屉未弹出，清理浮窗后重新点击加购`);
  114 |           if (attempt === 2) throw new Error('[Global] 加购后购物车抽屉未弹出（共点击 2 次）');
  115 |           await dismissAllPopups(page);
  116 |           await addToCartBtn.scrollIntoViewIfNeeded({ timeout: 10000 }).catch(() => {});
  117 |           await addToCartBtn.click({ timeout: 8000 }).catch(() => {});
  118 |         }
  119 |       }
  120 |       console.log(`[Global] ✅ 购物车抽屉已弹出`);
  121 | 
  122 |       // 定位方式：限定在购物车抽屉（dialog）内用 getByRole 定位商品链接
  123 |       // （页面导航菜单中也存在同名隐藏文本，不限定范围会被 .first() 误匹配）
  124 |       const productInCart = cartDrawer.getByRole('link', { name: PRODUCT_NAME }).first();
  125 |       await expect(productInCart).toBeVisible({ timeout: 10000 });
  126 |       console.log(`[Global] ✅ 购物车中存在目标商品: ${PRODUCT_NAME}`);
  127 |     });
  128 |   });
  129 | 
  130 |   test('商品正常进入结算页', async ({ sharedPage: page }) => {
  131 |     // ── Allure 报告信息：运行参数 + 预期结果 ──
  132 |     parameter('TARGET_URL', TARGET_URL);
  133 |     parameter('PRODUCT_NAME', PRODUCT_NAME);
  134 |     parameter('地区/语言', REGION);
  135 |     test.info().annotations.push(
  136 |       { type: '预期结果', description: '点击 Check out 后跳转结算页 /checkouts/，且订单摘要含目标商品' },
  137 |       { type: '前置条件', description: '上一用例已加购成功，购物车抽屉处于弹出状态（沿用页面现场）' },
  138 |     );
  139 | 
  140 |     // ========== 阶段1：前置检查（确认上一用例已加购成功） ==========
  141 |     // 严格断言 dialog 角色：顶部导航的 "My Cart" 文本会让 getByText 误报
  142 |     const cartDrawer = page.getByRole('dialog', { name: /my cart/i }).first();
  143 |     await test.step('前置检查：购物车抽屉处于弹出状态', async () => {
  144 |       // 本用例直接沿用上一用例的页面现场，不重新初始化、不重新加购
  145 |       await expect(cartDrawer).toBeVisible({ timeout: 15000 });
  146 |       console.log(`[Global] ✅ 购物车抽屉已弹出，直接开始点击 Check Out`);
  147 |     });
  148 | 
  149 |     // ========== 阶段2：点击 Check out 按钮进入结算页 ==========
  150 |     await test.step('弹窗清理并点击 Check out 按钮', async () => {
  151 |       // 定位方式：限定在购物车抽屉（dialog）内匹配 "Check out"
  152 |       // （该控件在不同渲染状态下可能是 button 或 link 角色，用逗号选择器兼容两种形态）
  153 |       const checkOutBtn = cartDrawer.locator('button, a').getByText(/check\s*out/i).first();
```