...
- generic [active] [ref=e1]:
        ...
        - generic [ref=e512]:
                    ...
                    - generic:
                      - generic:
                        ...
                        - generic [ref=f274e14]:
                          - generic [ref=f274e19]:
                            - generic [ref=f274e20]:
                              - link "BambuLab of CNC Milling? Makera Carvera Air Desktop Mill Reviewed" [ref=f274e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=WR7ROCYbwcc
                              - link "My Tech Fun" [ref=f274e22] [cursor=pointer]:
                                - /url: /channel/UC6QckhILSqdl3K0TWPWrDdg
                                - generic [ref=f274e23]: My Tech Fun
                            - generic [ref=f274e24]:
            ...
            - generic [ref=e591] [cursor=pointer]:
              ...
              - iframe [ref=e654]:
                - generic [active] [ref=f276e1]:
                  - generic "YouTube 動画プレーヤー" [ref=f276e3]
                  - generic [ref=f276e5]:
                    - generic:
                      - generic:
                        - button "動画を再生" [ref=f276e10] [cursor=pointer]
                        - button "プレーヤー コントロールを非表示にする" [ref=f276e12] [cursor=pointer]
                        - generic [ref=f276e14]:
                          - generic [ref=f276e19]:
                            - generic [ref=f276e20]:
                              - link "How I Made My Own iPhone from a Block of Aluminum" [ref=f276e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=Yrl4OmS3bBA
                              - link "Strange Parts" [ref=f276e22] [cursor=pointer]:
                                - /url: /channel/UCO8DQrSp5yEP937qNqTooOw
                                - generic [ref=f276e23]: Strange Parts
                            - generic [ref=f276e24]:
                              - button [ref=f276e25] [cursor=pointer]
                              - generic [ref=f276e27]:
                                - generic: Strange Parts
                                - generic: チャンネル登録者数 196万人
                          - generic [ref=f276e28]:
                            - button "共有" [ref=f276e31] [cursor=pointer]:
                              - generic [ref=f276e35]:
                                - img
                            - link "YouTube で見る" [ref=f276e42] [cursor=pointer]:
                              - /url: https://www.youtube.com/watch?v=Yrl4OmS3bBA
                              - generic [ref=f276e45]:
                                - text: 見る
                                - img [ref=f276e47]:
            ...
            - generic [ref=e667] [cursor=pointer]:
              ...
              - iframe [ref=e730]:
                - generic [active] [ref=f278e1]:
                  - generic "YouTube 動画プレーヤー" [ref=f278e3]
                  - generic [ref=f278e5]:
                    - generic:
                      - generic:
                        - button "動画を再生" [ref=f278e10] [cursor=pointer]
                        - button "プレーヤー コントロールを非表示にする" [ref=f278e12] [cursor=pointer]
                        - generic [ref=f278e14]:
                          - generic [ref=f278e19]:
                            - generic [ref=f278e20]:
                              - link "The BEST 4 Axis Desktop CNC Machine?" [ref=f278e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=ffZlPlssL-s
                              - link "TAOW" [ref=f278e22] [cursor=pointer]:
                                - /url: /channel/UCpV7D0LoRbYhdx2G-whWyog
                                - generic [ref=f278e23]: TAOW
                            - generic [ref=f278e24]:
                              - button [ref=f278e25] [cursor=pointer]
                              - generic [ref=f278e27]:
                                - generic: TAOW
                                - generic: チャンネル登録者数 26.4万人
                          - generic [ref=f278e28]:
                            - button "共有" [ref=f278e31] [cursor=pointer]:
                              - generic [ref=f278e35]:
                                - img
                            - link "YouTube で見る" [ref=f278e42] [cursor=pointer]:
                              - /url: https://www.youtube.com/watch?v=ffZlPlssL-s
                              - generic [ref=f278e45]:
                                - text: 見る
                                - img [ref=f278e47]:
          ...
          - generic [ref=e741]:
            - generic [ref=e743] [cursor=pointer]:
              - img [ref=e744]
              - iframe [ref=e806]:
                - generic [active] [ref=f280e1]:
                  - generic "YouTube 動画プレーヤー" [ref=f280e3]
                  - generic [ref=f280e5]:
                    - generic:
                      - generic:
                        - button "動画を再生" [ref=f280e10] [cursor=pointer]
                        - button "プレーヤー コントロールを非表示にする" [ref=f280e12] [cursor=pointer]
                        - generic [ref=f280e14]:
                          - generic [ref=f280e19]:
                            - generic [ref=f280e20]:
                              - link "Makera Carvera Auto Tool Changer Benchtop CNC machine, In-depth review, aluminum cutting stress test" [ref=f280e21] [cursor=pointer]:
                                - /url: https://www.youtube.com/watch?v=zN7eEzAqI3A
                              - link "Aurora Tech" [ref=f280e22] [cursor=pointer]:
                                - /url: /channel/UCGER4yfUXubhNVPYoNzBSEA
                                - generic [ref=f280e23]: Aurora Tech
                            - generic [ref=f280e24]:
                              - button [ref=f280e25] [cursor=pointer]
                              - generic [ref=f280e27]:
                                - generic: Aurora Tech
                                - generic: チャンネル登録者数 12.4万人
                          - generic [ref=f280e28]:
                            - button "共有" [ref=f280e31] [cursor=pointer]:
                              - generic [ref=f280e35]:
                                - img
                            - link "YouTube で見る" [ref=f280e42] [cursor=pointer]:
                              - /url: https://www.youtube.com/watch?v=zN7eEzAqI3A
                              - generic [ref=f280e45]:
                                - text: 見る
                                - img [ref=f280e47]:
  ...
  - generic:
    - generic:
      - generic [ref=e1092]:
        - iframe [ref=e1093]:
          - button "会社からのメッセージを閉じる" [ref=f284e3] [cursor=pointer]:
            - img [ref=f284e4]
        - iframe [ref=e1094]:
          - button "Hi. Need any help?" [ref=f285e4] [cursor=pointer]
      - iframe [ref=e1095]:
        - button "メッセージングウィンドウを開く" [ref=f286e4] [cursor=pointer]:
          - img [ref=f286e6]
          - img [ref=f286e9]
  - generic [ref=e1097]:
    - generic [ref=e1100]:
